...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path,old_dest = None):
    if os.path.isfile(dir_path_content):
        print(f"file found! {dir_path_content}")
        return generate_page(dir_path_content, template_path, old_dest)
    else:
        if os.path.isdir(dir_path_content):
            ...
            for file in files:
                ...
                generate_pages_recursive(full_file,template_path,new_target,dest_dir_path)              
        else:
            print("invalid file")    

generate_pages_recursive ("/home/bagath/workspace/Static_Site_Generator/content/","/home/bagath/workspace/Static_Site_Generator/template.html","/home/bagath/workspace/Static_Site_Generator/public")